...
const Cart = () => {
  ...
  const increaseQty = async(id, qty) => {
    ...
    if (responseData.success) {
      const cloneData = [...data].filter((e) => (e._id == responseData.data._id) ? e.quantity = responseData.data.quantity : e.quantity)
      setData(cloneData)
    }
  }
  ...
  const deleteCartProduct = async(id) => {
    ...
    if (responseData.success) {
      const cloneData = [...data].filter((e) => (e._id !== responseData.data._id))
      setData(cloneData)
